...
void drawOVehicle()//other cars
{
	...
	for (i = 0; i < 4; i++)
	{
		...
		glBegin(GL_QUADS);
		glColor3f(0, 0, 0.83984);//middle body
...
{
	printf("********** WELCOME TO THE CAR RACE **********\n");
	printf("This project is submitted by:\n");
	printf("Simran Ganju \t 1RN15CS105\n");
	printf("Vineet Bhikonde \t 1RN15CS124\n");
	glutInit(&argc, argv);
